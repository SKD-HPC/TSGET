...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        #print(w.shape)(16,12,197,64)
        #print(self.scale)
        dots = torch.matmul(w, w.transpose(-1, -2)) * self.scale
        #print(dots.shape)(16,12,197,197)
        attn = self.attend(dots)
        attn = self.dropout(attn)
        #print(attn.shape)(16,12,197,197)
        out = torch.matmul(attn, w)
        #print(out.shape)(16,12,197,64)
        out = rearrange(out, 'b h n d -> b n (h d)')
        #print(out.shape)(16,197,768)
        #print(self.to_out(out).shape)(16,197,768)
